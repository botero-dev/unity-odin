...
namespace OdinInterop
{
    ...
    public unsafe struct Slice<T> : IDisposable where T : unmanaged
    {
        ...
        {
            var s = OdinMem.AllocateWithAllocator(sizeof(T), UnsafeUtility.AlignOf<T>(), length, allocator);
        ...
        public void Dispose() => Dispose(OdinMem.GetAllocator());

        public void Dispose(Allocator allocator) => OdinMem.FreeWithAllocator(Reinterpret<byte>(), allocator);
    }
    ...
    public unsafe struct String8 : IDisposable // reinterpretable as Slice<byte>
    {
        ...
        public String8(string str, Allocator allocator)
        {
            ...
            var s = OdinMem.AllocateWithAllocator(1, 1, b.Length, allocator);
            if (s.ptr == null)
            {
                this = default;
                return;
    ...
    public unsafe struct String16 : IDisposable // reinterpretable as Slice<char>
    {
        ...
        public String16(string str, Allocator allocator)
        {
            ...
            var s2 = OdinMem.AllocateWithAllocator(2, 2, str.Length, allocator);
            if (s2.ptr == null)
            {
                this = default;
                return;
    ...
    public unsafe struct DynamicArray<T> : IDisposable where T : unmanaged // 'derived' from Slice<T>
    {
        ...
        {
            var s = OdinMem.AllocateWithAllocator(sizeof(T), UnsafeUtility.AlignOf<T>(), capacity, allocator);
        ...
        {
            var s = OdinMem.AllocateWithAllocator(sizeof(T), UnsafeUtility.AlignOf<T>(), list.Capacity, allocator);
            if (s.ptr == null)
            {
                this = default;
                return;
